...
void ComputerPlayerBase::inform(const Card c,const player_id::type from)
{
        ...
        if (c.suit() == Card::hearts)
        {
                ...
                { // the cast works because of the way ComputerPlayerBase::doingItAll_t is defined
...
void ComputerPlayerBase::reset(){
		...
		const Card::suit_t suits[] = { Card::hearts, Card::spades, Card::clubs, Card::diamonds };
