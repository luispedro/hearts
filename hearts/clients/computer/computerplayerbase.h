...
class ComputerPlayerBase
{
	...
	protected:
		...
		handIterator handBegin() const
		{
			return hand.begin();
		}
		handIterator handEnd() const
		{
			return hand.end();
		}
		...
		bool hasHighSpades() const
		{
			return hasHighSpades_;
		}
		bool heartsPlayed() const
		{
			return heartsPlayed_;
		}
		bool queenOut() const
		{
			return queenOut_;
		...
		int suitPlayed( Card::suit_t t ) const
		{
			return suitInfo[ t ].played;
		}
		bool suitHasIt( Card::suit_t t ) const
		{
			return suitInfo[ t ].hasIt;
		}
		bool suitSkipped( Card::suit_t t ) const
		{
			return suitInfo[ t ].skipped;
		}
		bool suitSkippedAll( Card::suit_t t ) const
		{
			return suitInfo[ t ].skippedAll;
		}
