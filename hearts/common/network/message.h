...
#undef HANDLE
				...
				QString arg( size_t idx ) const { return pieces_[ idx + 1]; }
...
{
		if ( r.isNull() )  static_cast<QStringList&>( *this ) << QString::fromLatin1( "[null]" );
		else static_cast<QStringList&>( *this ) << r;
		return *this;
}
...
template<>
inline const QString to<QString>( const QString& r ) { return r; }

template<>
inline const short to<short>( const QString& r ) { return r.toInt(); }
